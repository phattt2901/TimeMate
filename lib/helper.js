...
exports.GetTimeFrame = (start, end, format = "DD/MM/YYYY") => {
  try {
    if (!start || !end) {
      return {
        message: "Start date or End date invaild",
      };
    }
...
/**
 * Get Start date of weeks, months, years.
 * @param {string} date The string date like "23/01/2023" or "2023-01-04".
 * @param {string} format format Date like "DD/MM/YYYY".
 * @param {string} type type you want to get "weeks","months" or "years".
 * @returns {boolean} return true/false
 */
exports.GetStartDate = (date, format, type) => {
  try {
    let validDate = this.IsValidDate(date);
    if (!validDate) {
      return {
...
/**
 * Get End date of weeks, months, years.
 * @param {string} date The string date like "23/01/2023" or "2023-01-04".
 * @param {string} format format Date like "DD/MM/YYYY".
 * @param {string} type type you want to get "weeks","months" or "years".
 * @returns {boolean} return true/false
